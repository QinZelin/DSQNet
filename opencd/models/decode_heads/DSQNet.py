...
class CFP(BaseModule):
    def __init__(self,
        ...
        # if we adopt Conv layer with large kernel_size, the numbers of parameters of model will increase by about 1M.
        # It is suggested to adopt the AvgPool2d layer showed below. The result is similar.
